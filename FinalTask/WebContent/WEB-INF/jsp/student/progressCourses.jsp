...
<br />
<lc:Loc word='Table of courses which are in progress' locale='${sessionScope.language}'/>
...
<input type="hidden" name="Coursecommand" value="progressCourses"/>
<input type="hidden" name="incommand" value="sortStudentCourses" />
<input type="hidden" name="order" value="${requestScope.order}"/>
</form></th>

<th><lc:Loc word='Start date' locale='${sessionScope.language}'/>
</th>
