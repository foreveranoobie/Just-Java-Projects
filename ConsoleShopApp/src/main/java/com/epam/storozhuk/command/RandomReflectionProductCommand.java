...
public class RandomReflectionProductCommand implements Command {
    ...
    public RandomReflectionProductCommand(ApplicationContext applicationContext) {
        this.reader = applicationContext.getReaderService();
        productService = applicationContext.getProductService();
        reflectionInput = new RandomReflectionInput();
