...
public class Part2 {
	...
	public static String convert(String input) {
		int maxWord = 0;
		Pattern p = Pattern.compile("[A-Za-zÀ-ß¨²¯ªÝà-ÿ¸³¿ýº]+", Pattern.MULTILINE | Pattern.UNICODE_CHARACTER_CLASS);
		...
		p = Pattern.compile("\\b[A-Za-zÀ-ß¨²¯ªÝà-ÿ¸³¿ýº]{" + lowest + "}\\b",
		...
		p = Pattern.compile("\\b[A-Za-zÀ-ß¨²¯ªÝà-ÿ¸³¿ýº]{" + maxWord + "}\\b",
				Pattern.MULTILINE | Pattern.UNICODE_CHARACTER_CLASS);
		m = p.matcher(input);
		while (m.find()) {
